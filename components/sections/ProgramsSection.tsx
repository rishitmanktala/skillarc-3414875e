...
const getProgramIcon = (index: number) => {
  switch (index) {
    ...
    case 1:
      return <Flag className="w-8 h-8 text-accent" />;
    case 2:
      return <GraduationCap className="w-8 h-8 text-highlight" />;
    case 3:
            ...
            >
              ...
              >
                ...
                <div className="p-6 md:p-8 flex flex-col items-start flex-grow">
                  ...
                  {/* Link styled button */}
                  <button className="inline-flex items-center gap-2 font-body text-sm font-semibold text-[#89c5d7] hover:text-[#5faabf] transition-colors mt-auto group/btn select-none">
                    Learn More
